...
public class MainFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        title.setTypeface(Typeface.createFromAsset(getActivity().getAssets(), "fonts/a하얀구름.ttf"));
        title.setText("NARAE");



        TextView subtitle = (TextView)view.findViewById(R.id.subtitle_name);
        subtitle.setTypeface(Typeface.createFromAsset(getActivity().getAssets(), "fonts/HoonWhitecatR.ttf"));
